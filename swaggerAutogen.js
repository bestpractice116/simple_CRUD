...
const doc = {
  ...
  host: 'localhost:5173', // Replace with your host and port
  schemes: ['http'], // Use https if applicable
};

const outputFile = './swagger-output.json'; // File to write Swagger spec
const endpointsFiles = ["./index.js", "./src/router/*.js", "./src/controller/*.js", "./src/services/*.js", "./src/middleware/*.js"]; // Your root file or routes files
